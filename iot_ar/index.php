...
$qry=mysqli_query($connect,"select * from animal_log where uname='$uname' && pass='$pass'");
	...
	<div class="header_section">
		<div class="container">
            ...
            <ul class="top_button_section">
               <li><a class="login-bt active" href="index.php">Home</a></li>
			   <!--<li><a class="login-bt" href="/monitor">Monitor</a></li>
               <li><a class="login-bt" href="/login">Admin</a></li>-->
		    ...
		    <div class="enput_bt">
		    	<div class="row">
		    		<div class="col-md-6">
                       ...
                       <div class="container">
					   <h3 style="color:#99FF00"><?php echo $msg; ?></h3>
                          <form action="" method="post">
                            ...
                            <div class="form-group">
                              <input type="password" class="email-bt" placeholder="Password" name="pass">
                           	...
                           	<div class="left">
                       		<input class="send_bt" type="submit" name="btn" value="Login">
							</form>
                       	</div>
		    		...
		    		<div class="col-md-6">
			            ...
			            <div class="col-sm-12">
				            <div class="full map_section">
                                <img src="images/mg1.png" style="max-width: 90%; border:3px solid #009933; border-radius: 25px;"/>
                            </div>
			            </div>
		            </div>
	                 </div>
