...
class VideoCamera2(object):
    ...
    def get_frame(self):
        ...
        classNames = { 1: 'Bear', 2: 'Cow', 3: 'Elephant', 4: 'Goat',
            5: 'Horse', 6: 'Pig', 7: 'Sheep', 8: 'Lion', 9: 'Cheetah', 10: 'Fox' }
                ...
                if confidence > args.thr: # Filter prediction 
                    ...
                    if self.k<=40:
                        ...
                        if uu1=="2":
                            ...
                            mm2 = PIL.Image.open('static/frame/'+fnn)
                            rz = mm2.resize((300,300), PIL.Image.ANTIALIAS)
                            rz.save('static/frame/'+fnn)
                            shutil.copy('static/frame/'+fnn, 'static/faces/f1.jpg')
